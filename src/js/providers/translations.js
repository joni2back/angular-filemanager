(function (angular) {
    ...
    angular.module('FileManagerApp').config(['$translateProvider', function ($translateProvider) {
        ...
        $translateProvider.translations('en', {
            ...
            sure_to_delete_with_usage_reference: 'Warning: You are deleting a document that is already linked to a course design.',
        ...
        $translateProvider.translations('de', {
            ...
            sure_to_delete_with_usage_reference: 'Achtung: Sie löschen ein Dokument, welches bereits mit einer Lehrskizze verknüpft ist.',
